package com.internshala.bookish.fragment
...
import com.internshala.bookish.adapter.DashboardRecyclerAdapter
import com.internshala.bookish.model.Book
import com.internshala.bookish.util.ConnectionManager
            ...
            if(activity !=null){
                ...
                override fun getHeaders(): MutableMap <String, String> {
                    ...
                    //headers["token"]="9bf534118365f1"
                     headers["token"]="839ebf18fdae67"
                    return headers
                }
            }

            //adding the request queue
